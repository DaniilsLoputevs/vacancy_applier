...
fun loginHH(driver: RemoteWebDriver, loginDetails : LoginDetailsHH) {
    ...
    println("Вам нужно нажать \"Войти\", пройти Captcha и нажать \"Войти\" снова - на это у вас 2 минуты")
...
private fun loginWithCode(driver: ChromeDriver, loginDetails : LoginDetailsHH) {
